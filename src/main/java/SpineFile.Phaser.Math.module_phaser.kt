...
external open class Euler(x: Number = definedExternally, y: Number = definedExternally, z: Number = definedExternally)
...
external open class Matrix4(m: Matrix4 = definedExternally) {
    ...
    open fun setValues(m00: Number, m01: Number, m02: Number, m03: Number, m10: Number, m11: Number, m12: Number, m13: Number, m20: Number, m21: Number, m22: Number, m23: Number, m30: Number, m31: Number, m32: Number, m33: Number): Matrix4 /* this */
    ...
    open fun frustum(left: Number, right: Number, bottom: Number, top: Number, near: Number, far: Number): Matrix4 /* this */
    ...
    open fun ortho(left: Number, right: Number, bottom: Number, top: Number, near: Number, far: Number): Matrix4 /* this */
    ...
    open fun setWorldMatrix(rotation: Vector3, position: Vector3, scale: Vector3, viewMatrix: Matrix4 = definedExternally, projectionMatrix: Matrix4 = definedExternally): Matrix4 /* this */
    open fun multiplyToMat4(src: Matrix4, out: Matrix4): Matrix4
    open fun fromRotationXYTranslation(rotation: Vector3, position: Vector3, translateFirst: Boolean): Matrix4 /* this */
...
external open class Quaternion(x: Number = definedExternally, y: Number = definedExternally, z: Number = definedExternally, w: Number = definedExternally) {
    ...
    open fun set(x: Number? = definedExternally, y: Number = definedExternally, z: Number = definedExternally, w: Number = definedExternally, update: Boolean = definedExternally): Quaternion
    ...
    open fun set(x: Any? = definedExternally, y: Number = definedExternally, z: Number = definedExternally, w: Number = definedExternally, update: Boolean = definedExternally): Quaternion
