...
external open class Circle(x: Number = definedExternally, y: Number = definedExternally, radius: Number = definedExternally) {
    ...
    open fun <O : Array<Point>> getPoints(quantity: Number, stepRate: Number = definedExternally, output: O = definedExternally): O
    ...
    companion object {
        ...
        fun GetPoints(circle: Circle, quantity: Number, stepRate: Number = definedExternally, output: Array<Any> = definedExternally): Array<Point>
...
external open class Ellipse(x: Number = definedExternally, y: Number = definedExternally, width: Number = definedExternally, height: Number = definedExternally) {
    ...
    companion object {
        ...
        fun <O : Array<Point>> GetPoints(ellipse: Ellipse, quantity: Number, stepRate: Number = definedExternally, out: O = definedExternally): O
...
external open class Line(x1: Number = definedExternally, y1: Number = definedExternally, x2: Number = definedExternally, y2: Number = definedExternally) {
    ...
    companion object {
        ...
        fun BresenhamPoints(line: Line, stepRate: Number = definedExternally, results: Array<Vector2Like> = definedExternally): Array<Vector2Like>
        ...
        fun <O : Array<Point>> GetEasedPoints(line: Line, ease: String, quantity: Number, collinearThreshold: Number = definedExternally, easeParams: Array<Number> = definedExternally): O
        fun <O : Array<Point>> GetEasedPoints(line: Line, ease: Function<*>, quantity: Number, collinearThreshold: Number = definedExternally, easeParams: Array<Number> = definedExternally): O
        ...
        fun <O : Array<Point>> GetPoints(line: Line, quantity: Number, stepRate: Number = definedExternally, out: O = definedExternally): O
...
external open class Polygon {
    ...
    companion object {
        ...
        fun Earcut(data: Array<Number>, holeIndices: Array<Number> = definedExternally, dimensions: Number = definedExternally): Array<Number>
        ...
        fun GetPoints(polygon: Polygon, quantity: Number, stepRate: Number = definedExternally, output: Array<Any> = definedExternally): Array<Point>
        fun Perimeter(polygon: Polygon): Number
        fun <O : Polygon> Reverse(polygon: O): O
        fun <O : Polygon> Simplify(polygon: O, tolerance: Number = definedExternally, highestQuality: Boolean = definedExternally): O
...
external open class Rectangle(x: Number = definedExternally, y: Number = definedExternally, width: Number = definedExternally, height: Number = definedExternally) {
    ...
    companion object {
        ...
        fun <O : Array<Point>> GetPoints(rectangle: Rectangle, step: Number, quantity: Number, out: O = definedExternally): O
        ...
        fun <O : Array<Point>> MarchingAnts(rect: Rectangle, step: Number = definedExternally, quantity: Number = definedExternally, out: O = definedExternally): O
