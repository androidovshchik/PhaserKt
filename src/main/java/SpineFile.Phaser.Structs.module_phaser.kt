...
external open class List<T>(parent: Any) {
    ...
    open fun getAll(property: String = definedExternally, value: T = definedExternally, startIndex: Number = definedExternally, endIndex: Number = definedExternally): Array<T>
    ...
    open fun removeBetween(startIndex: Number = definedExternally, endIndex: Number = definedExternally, skipCallback: Boolean = definedExternally): Array<T>
    ...
    open fun setAll(property: String, value: T, startIndex: Number = definedExternally, endIndex: Number = definedExternally)
...
external open class Size(width: Number = definedExternally, height: Number = definedExternally, aspectMode: Number = definedExternally, parent: Any = definedExternally) {
    open var aspectMode: Number
    ...
    companion object {
        var NONE: Number
        var WIDTH_CONTROLS_HEIGHT: Number
        var HEIGHT_CONTROLS_WIDTH: Number
        var FIT: Number
        var ENVELOP: Number
    }
}