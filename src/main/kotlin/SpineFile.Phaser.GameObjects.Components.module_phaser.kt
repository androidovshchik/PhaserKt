...
external interface Pipeline {
    ...
    var postPipeline: Array<PostFXPipeline>
    var pipelineData: Any?
    fun initPipeline(pipeline: String): Boolean
    fun initPipeline(pipeline: WebGLPipeline): Boolean
    fun setPipeline(pipeline: String, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPipeline(pipeline: WebGLPipeline, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: String, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: Array<String>, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: Function<*>, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: Array<Function<*>>, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: PostFXPipeline, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
    ...
    fun setPostPipeline(pipelines: Array<PostFXPipeline>, pipelineData: Any? = definedExternally, copyData: Boolean = definedExternally): Pipeline /* this */
...
external interface Texture {
    ...
    fun setFrame(frame: Number, updateSize: Boolean = definedExternally, updateOrigin: Boolean = definedExternally): Texture /* this */
...
external interface TextureCrop {
    ...
    fun setFrame(frame: Number, updateSize: Boolean = definedExternally, updateOrigin: Boolean = definedExternally): TextureCrop /* this */
...
external interface Tint {
    ...
    fun setTint(topLeft: Number = definedExternally, topRight: Number = definedExternally, bottomLeft: Number = definedExternally, bottomRight: Number = definedExternally): Tint /* this */
    fun setTintFill(topLeft: Number = definedExternally, topRight: Number = definedExternally, bottomLeft: Number = definedExternally, bottomRight: Number = definedExternally): Tint /* this */
    var tint: Number
...
external interface Transform {
    ...
    fun getLocalPoint(x: Number, y: Number, point: Vector2 = definedExternally, camera: Camera = definedExternally): Vector2
