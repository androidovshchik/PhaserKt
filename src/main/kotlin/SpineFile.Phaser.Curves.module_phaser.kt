...
external open class Curve(type: String) {
    ...
    open fun <O : Array<Vector2>> getPoints(divisions: Number = definedExternally, stepRate: Number = definedExternally, out: O = definedExternally): O
    open fun <O : Vector2> getRandomPoint(out: O = definedExternally): O
    open fun getSpacedPoints(divisions: Number = definedExternally, stepRate: Number = definedExternally, out: Array<Any> = definedExternally): Array<Vector2>
    open fun getSpacedPoints(): Array<Vector2>
    open fun getSpacedPoints(divisions: Number = definedExternally): Array<Vector2>
    open fun getSpacedPoints(divisions: Number = definedExternally, stepRate: Number = definedExternally): Array<Vector2>
    open fun getSpacedPoints(divisions: Number = definedExternally, stepRate: Number = definedExternally, out: Array<Vector2> = definedExternally): Array<Vector2>
...
external open class Ellipse : Curve {
    constructor(x: Number = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally, clockwise: Boolean = definedExternally, rotation: Number = definedExternally)
    constructor()
    ...
    constructor(x: Number = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally)
    constructor(x: Number = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally)
    constructor(x: Number = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally, clockwise: Boolean = definedExternally)
    constructor(x: EllipseCurveConfig = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally, clockwise: Boolean = definedExternally, rotation: Number = definedExternally)
    ...
    constructor(x: EllipseCurveConfig = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally)
    constructor(x: EllipseCurveConfig = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally)
    constructor(x: EllipseCurveConfig = definedExternally, y: Number = definedExternally, xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally, clockwise: Boolean = definedExternally)
    open var p0: Vector2
    override fun <O : Vector2> getStartPoint(out: O): O
    open fun getResolution(divisions: Number): Number
    open fun <O : Vector2> getPoint(t: Number, out: O = definedExternally): O
...
external open class Path(x: Number = definedExternally, y: Number = definedExternally) {
    ...
    open fun ellipseTo(xRadius: Number = definedExternally, yRadius: Number = definedExternally, startAngle: Number = definedExternally, endAngle: Number = definedExternally, clockwise: Boolean = definedExternally, rotation: Number = definedExternally): Path /* this */
