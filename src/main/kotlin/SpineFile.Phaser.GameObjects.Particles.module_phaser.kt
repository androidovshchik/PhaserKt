...
external open class ParticleEmitter(manager: ParticleEmitterManager, config: ParticleEmitterConfig) : BlendMode, Mask, ScrollFactor, Visible {
    ...
    open fun setFrame(frames: Array<Any>, pickRandom: Boolean = definedExternally, quantity: Number = definedExternally): ParticleEmitter /* this */
    ...
    open fun setFrame(frames: String, pickRandom: Boolean = definedExternally, quantity: Number = definedExternally): ParticleEmitter /* this */
    ...
    open fun setFrame(frames: Number, pickRandom: Boolean = definedExternally, quantity: Number = definedExternally): ParticleEmitter /* this */
    ...
    open fun setFrame(frames: ParticleEmitterFrameConfig, pickRandom: Boolean = definedExternally, quantity: Number = definedExternally): ParticleEmitter /* this */
    ...
    open fun explode(count: Number, x: Number, y: Number): Particle
    open fun emitParticleAt(x: Number = definedExternally, y: Number = definedExternally, count: Number = definedExternally): Particle
    open fun emitParticle(count: Number = definedExternally, x: Number = definedExternally, y: Number = definedExternally): Particle
...
external open class ParticleEmitterManager : GameObject, Depth, Mask, Pipeline, Transform, Visible {
    ...
    constructor(scene: Scene, texture: String, frame: Number = definedExternally, emitters: ParticleEmitterConfig = definedExternally)
    constructor(scene: Scene, texture: String, frame: Number = definedExternally)
    constructor(scene: Scene, texture: String, frame: Number = definedExternally, emitters: Array<ParticleEmitterConfig> = definedExternally)
    open var timeScale: Number
    open var texture: Texture
    open var frame: Frame
    ...
    open fun emitParticle(count: Number = definedExternally, x: Number = definedExternally, y: Number = definedExternally): ParticleEmitterManager /* this */
    open fun emitParticleAt(x: Number = definedExternally, y: Number = definedExternally, count: Number = definedExternally): ParticleEmitterManager /* this */
    ...
    override fun setPipeline(pipeline: String, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    ...
    override fun setPipeline(pipeline: WebGLPipeline, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPipeline(pipeline: WebGLPipeline): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPipeline(pipeline: WebGLPipeline, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: String, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    ...
    override fun setPostPipeline(pipelines: Array<String>, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<String>): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<String>, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Function<*>, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Function<*>): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Function<*>, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<Function<*>>, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<Function<*>>): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<Function<*>>, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: PostFXPipeline, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: PostFXPipeline): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: PostFXPipeline, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<PostFXPipeline>, pipelineData: Any?, copyData: Boolean): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<PostFXPipeline>): dynamic /* ParticleEmitterManager | Pipeline */
    override fun setPostPipeline(pipelines: Array<PostFXPipeline>, pipelineData: Any?): dynamic /* ParticleEmitterManager | Pipeline */
