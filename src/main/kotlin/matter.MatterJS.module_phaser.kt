...
external open class Plugin {
    ...
    companion object {
        ...
        fun isFor(plugin: Plugin, module: `T$23`): Boolean
        fun use(module: `T$24`, plugins: Array<Any /* Plugin | String */>)
        fun dependencies(module: `T$21`, tracked: `T$25` = definedExternally): dynamic /* `T$26`? | String? */
        fun dependencies(module: `T$22`, tracked: `T$25` = definedExternally): dynamic /* `T$26`? | String? */
        fun dependencies(module: String, tracked: `T$25` = definedExternally): dynamic /* `T$26`? | String? */
        fun dependencyParse(dependency: `T$21`): `T$21`
        fun dependencyParse(dependency: `T$22`): `T$21`
        fun dependencyParse(dependency: String): `T$21`
        fun versionParse(range: String): `T$27`
