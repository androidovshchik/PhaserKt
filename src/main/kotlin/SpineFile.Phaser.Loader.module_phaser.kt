...
import Phaser.Types.Loader.FileTypes.AsepriteFileConfig
...
import Phaser.Types.Loader.FileTypes.OBJFileConfig
...
external open class LoaderPlugin(scene: Scene) : EventEmitter {
    ...
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: String, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: AsepriteFileConfig, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: String = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: Any? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally, atlasXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally): LoaderPlugin /* this */
    open fun aseprite(key: Array<AsepriteFileConfig>, textureURL: Array<String> = definedExternally, atlasURL: String? = definedExternally, textureXhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun htmlTexture(key: String, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun htmlTexture(key: String, url: String = definedExternally, width: Number = definedExternally): LoaderPlugin /* this */
    open fun htmlTexture(key: String, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally): LoaderPlugin /* this */
    open fun htmlTexture(key: HTMLTextureFileConfig, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun htmlTexture(key: HTMLTextureFileConfig, url: String = definedExternally, width: Number = definedExternally): LoaderPlugin /* this */
    open fun htmlTexture(key: HTMLTextureFileConfig, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally): LoaderPlugin /* this */
    open fun htmlTexture(key: Array<HTMLTextureFileConfig>, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun htmlTexture(key: Array<HTMLTextureFileConfig>, url: String = definedExternally, width: Number = definedExternally): LoaderPlugin /* this */
    open fun htmlTexture(key: Array<HTMLTextureFileConfig>, url: String = definedExternally, width: Number = definedExternally, height: Number = definedExternally): LoaderPlugin /* this */
    ...
    open fun obj(key: String, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    open fun obj(key: String): LoaderPlugin /* this */
    open fun obj(key: String, objURL: String = definedExternally): LoaderPlugin /* this */
    open fun obj(key: String, objURL: String = definedExternally, matURL: String = definedExternally): LoaderPlugin /* this */
    open fun obj(key: String, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally): LoaderPlugin /* this */
    open fun obj(key: OBJFileConfig, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun obj(key: OBJFileConfig, objURL: String = definedExternally, matURL: String = definedExternally): LoaderPlugin /* this */
    open fun obj(key: OBJFileConfig, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally): LoaderPlugin /* this */
    open fun obj(key: Array<OBJFileConfig>, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally, xhrSettings: XHRSettingsObject = definedExternally): LoaderPlugin /* this */
    ...
    open fun obj(key: Array<OBJFileConfig>, objURL: String = definedExternally, matURL: String = definedExternally): LoaderPlugin /* this */
    open fun obj(key: Array<OBJFileConfig>, objURL: String = definedExternally, matURL: String = definedExternally, flipUV: Boolean = definedExternally): LoaderPlugin /* this */
...
external fun XHRSettings(responseType: String /* "" | "arraybuffer" | "blob" | "document" | "json" | "text" */ = definedExternally, async: Boolean = definedExternally, user: String = definedExternally, password: String = definedExternally, timeout: Number = definedExternally, withCredentials: Boolean = definedExternally): XHRSettingsObject