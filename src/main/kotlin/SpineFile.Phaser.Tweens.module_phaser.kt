...
external fun TweenData(target: Any, index: Number, key: String, getEnd: Function<*>, getStart: Function<*>, getActive: Function<*>, ease: Function<*>, delay: Number, duration: Number, yoyo: Boolean, hold: Number, repeat: Number, repeatDelay: Number, flipX: Boolean, flipY: Boolean): TweenDataConfig
