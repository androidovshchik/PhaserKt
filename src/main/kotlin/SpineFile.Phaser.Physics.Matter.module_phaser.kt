...
import ru.androidovshchik.MissingClass
...
external open class Factory(world: World) {
    ...
    open fun imageStack(key: String, frame: Number, x: Number, y: Number, columns: Number, rows: Number, columnGap: Number = definedExternally, rowGap: Number = definedExternally, options: MatterBodyConfig = definedExternally): CompositeType
    open fun imageStack(key: String, frame: Number, x: Number, y: Number, columns: Number, rows: Number): CompositeType
    open fun imageStack(key: String, frame: Number, x: Number, y: Number, columns: Number, rows: Number, columnGap: Number = definedExternally): CompositeType
    open fun imageStack(key: String, frame: Number, x: Number, y: Number, columns: Number, rows: Number, columnGap: Number = definedExternally, rowGap: Number = definedExternally): CompositeType
    ...
    open fun image(x: Number, y: Number, key: String, frame: Number = definedExternally, options: MatterBodyConfig = definedExternally): Image
    ...
    open fun sprite(x: Number, y: Number, key: String, frame: Number = definedExternally, options: MatterBodyConfig = definedExternally): Sprite
    open fun sprite(x: Number, y: Number, key: String, frame: Number = definedExternally): Sprite
    open fun gameObject(gameObject: GameObject, options: MatterBodyConfig = definedExternally, addToWorld: Boolean = definedExternally): dynamic /* Phaser.Physics.Matter.Image | Phaser.Physics.Matter.Sprite | Phaser.GameObjects.GameObject */
    ...
    open fun gameObject(gameObject: GameObject, options: MatterBodyConfig = definedExternally): dynamic /* Phaser.Physics.Matter.Image | Phaser.Physics.Matter.Sprite | Phaser.GameObjects.GameObject */
    open fun gameObject(gameObject: GameObject, options: Body = definedExternally, addToWorld: Boolean = definedExternally): dynamic /* Phaser.Physics.Matter.Image | Phaser.Physics.Matter.Sprite | Phaser.GameObjects.GameObject */
    open fun gameObject(gameObject: GameObject, options: Body = definedExternally): dynamic /* Phaser.Physics.Matter.Image | Phaser.Physics.Matter.Sprite | Phaser.GameObjects.GameObject */
    open fun destroy()
}
...
@MissingClass("Transform")
external open class Image : Phaser.GameObjects.Image, Bounce, Collision, Force, Friction, Gravity, Mass, Sensor, SetBody, Sleep, Static, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Size, _Phaser_GameObjects_Components_Texture, Tint, _Phaser_GameObjects_Components_Transform, Visible {
    ...
    constructor(world: World, x: Number, y: Number, texture: String, frame: Number = definedExternally, options: MatterBodyConfig = definedExternally)
    ...
    constructor(world: World, x: Number, y: Number, texture: Texture, frame: Number = definedExternally, options: MatterBodyConfig = definedExternally)
    ...
    fun setPosition(x: Number, y: Number): Transform
    ...
    fun setScale(x: Number, y: Number, point: Vector2): Transform
    ...
    fun setFixedRotation(): Image /* this */
...
@MissingClass("Transform")
external open class Sprite : Phaser.GameObjects.Sprite, Bounce, Collision, Force, Friction, Gravity, Mass, Sensor, SetBody, Sleep, Static, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Size, _Phaser_GameObjects_Components_Texture, Tint, _Phaser_GameObjects_Components_Transform, Visible {
    constructor(world: World, x: Number, y: Number, texture: String, frame: String = definedExternally, options: MatterBodyConfig = definedExternally)
    constructor(world: World, x: Number, y: Number, texture: String)
    constructor(world: World, x: Number, y: Number, texture: String, frame: String = definedExternally)
    constructor(world: World, x: Number, y: Number, texture: String, frame: Number = definedExternally, options: MatterBodyConfig = definedExternally)
    ...
    override fun setStatic(value: Boolean): GameObject
    override fun isStatic(): Boolean
    fun setFixedRotation(): Sprite /* this */
    override fun setAngularVelocity(value: Number): GameObject
    override fun setVelocityX(x: Number): GameObject
    override fun setVelocityY(y: Number): GameObject
    override fun setVelocity(x: Number, y: Number): GameObject
